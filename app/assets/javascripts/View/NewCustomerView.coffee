...
nav_template = '
<ul class="customer_info nav nav-tabs">
	<li class="active"><a data-toggle="tab" href="#basic_info">基本資料</a></li>
	<li><a data-toggle="tab" href="#company_info">公司資訊</a></li>
	<li><a data-toggle="tab" href="#value_info">進階資訊</a></li>
</ul>
'
...
class AM.View.NewCustomerView extends Backbone.View
	...
	template: nav_template +
		'<div class="tab-content">' +
			basic_info_template + company_info_template + value_info_template + 
		'</div>' +
		commit_button
